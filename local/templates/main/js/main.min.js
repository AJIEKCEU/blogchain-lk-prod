...
"use strict";$((function(){var e,t,s=$("html").attr("lang"),a={searchText:"Поиск...",noMatch:'Ничего не найдено "{0}"',locale:["OK","Отмена","Выбрать все"],captionFormat:"{0} Выбрано",captionFormatAllSelected:"{0} Все выбраны!",fancybox:{CLOSE:"Закрыть",NEXT:"Дальше",PREV:"Назад",ERROR:"Запрошенный контент не может быть загружен. <br/> Попробуйте позже.",PLAY_START:"Начать слайдшоу",PLAY_STOP:"Остановить слайдшоу",FULL_SCREEN:"Полный экран",THUMBS:"Плиткой",DOWNLOAD:"Скачать",SHARE:"Поделиться",ZOOM:"Увеличить"}};switch(s){case"ru":default:t={ru:(e=a).fancybox}}var n={win:$(window),body:$("body"),main:$(".main"),nav:$(".js-nav"),header:$(".header"),btnMenu:$(".js-toggle-menu"),shadowMenu:$(".header-nav-shadow"),toggleSelect:$(".js-filter-select__button"),toggleSelectBody:$(".js-filter-select__body"),scrollableElement:document.querySelector(".menu"),eventMenu:function(){var e=window.screen.width;n.nav.toggleClass("js-nav--open"),n.btnMenu.toggleClass("js-toggle-menu--active"),n.shadowMenu.toggleClass("header-nav-shadow--active"),n.nav.contains("js-nav--open")&&e<1200?scrollLock.disablePageScroll(n.scrollableElement):scrollLock.enablePageScroll(n.scrollableElement)},selectSearch:function(){$(".js-select").SumoSelect({search:!0,searchText:e.searchText,noMatch:e.noMatch,locale:e.locale,captionFormat:e.captionFormat,captionFormatAllSelected:e.captionFormatAllSelected})},selectNoSearch:function(){$(".js-select-no-search").SumoSelect({search:!1})},eventSelect:function(){n.toggleSelect.toggleClass("js-filter-select__button--is-active"),n.toggleSelectBody.toggleClass("js-filter-select__body--is-open")}};n.toggleSelect.on("click",(function(){n.eventSelect()})),$(document).on("click",(function(e){$(e.target).closest(".js-filter-select").length||($(".js-filter-select__button").hasClass("js-filter-select__button--is-active")&&(n.toggleSelect.removeClass("js-filter-select__button--is-active"),n.toggleSelectBody.removeClass("js-filter-select__body--is-open")),e.stopPropagation())})),n.selectSearch(),n.selectNoSearch(),n.btnMenu.on("click",(function(){n.eventMenu()})),n.shadowMenu.on("click",(function(){n.eventMenu()})),n.body.on("click",".menu__link-wrp",(function(e){n.win.width()<1199&&"A"!==e.target.tagName&&(e.preventDefault(),$(this).hasClass("show-submenu")?$(".menu__link-wrp").removeClass("show-submenu").stop(!0).next(".submenu").slideUp():($(".menu__link-wrp").removeClass("show-submenu").stop(!0).next(".submenu").slideUp(),$(this).addClass("show-submenu").stop(!0).next(".submenu").slideDown()))})),n.body.on("click",".submenu__link-wrp",(function(e){if(n.win.width()<1199&&"A"!==e.target.tagName){e.preventDefault();var t=$(this).closest(".submenu");$(this).hasClass("show-submenu")?t.find(".submenu__link-wrp").removeClass("show-submenu").next(".submenu").stop(!0).slideUp():(t.find(".submenu__link-wrp").removeClass("show-submenu").next(".submenu").stop(!0).slideUp(),$(this).addClass("show-submenu").next(".submenu").stop(!0).slideDown())}}));var o=0,l=1;function r(e,t){var s,a=0,n='<div class="form-message form-message--error">Заполните обязательные поля!</div>',o=t||!1,l=$(e),r=l.data("ajax"),i=l.find('input[type="email"].chk'),c=i.val();if(l.find(".form-message").remove(),l.find(".chk").each((function(){var e=$(this);e.val()?(e.hasClass("inputfile")&&e.closest(".file").removeClass("file_err"),e.removeClass("err"),e.next(".selected").removeClass("err")):(e.hasClass("inputfile")&&e.closest(".file").addClass("file_err"),e.addClass("err"),l.find(".form-message").remove(),o.after(n),a=1)})),i.length&&(s=c,new RegExp(/^(("[\w-\s]+")|([\w-]+(?:\.[\w-]+)*)|("[\w-\s]+")([\w-]+(?:\.[\w-]+)*))(@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$)|(@\[?((25[0-5]\.|2[0-4][0-9]\.|1[0-9]{2}\.|[0-9]{1,2}\.))((25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\.){2}(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\]?$)/i).test(s)?i.removeClass("err"):(i.addClass("err"),l.find(".form-message").remove(),o.after(n),a=1)),0===a){if(void 0!==r){l.find("[type=submit]").prop("disabled",!0);var u=new FormData(l.get(0));return!1!==o&&u.append(o.attr("name"),o.val()),$.ajax({type:"POST",url:r,data:u,processData:!1,contentType:!1,dataType:"html",success:function(e){l.find(".form-message").remove(),l.find("[type=submit]").prop("disabled",!1),"Y"===(u=JSON.parse(e)).result?(l.find('input:not([type="submit"],[type="hidden"]),textarea').val(""),o.after(u.html)):o.after(u.html)}}),!1}return l.find(".form-message").remove(),!0}return l.find(".form-message").remove(),o.after(n),!1}n.win.scroll((function(){var e=n.win.scrollTop(),t=(n.win.outerWidth(),$(this).scrollTop());!function(e,t,s,a){0!==e?(s>o&&e>=a?l&&(l=0,n.header.stop(!0).animate({top:-a},300,(function(){$(this).addClass("header--fixed"),$(this).removeClass("header--fixed-show"),n.main.css("padding-top",a)}))):l||(l=1,n.header.stop(!0).animate({top:0},300,(function(){$(this).addClass("header--fixed-show")}))),o=s):(l=1,n.header.stop(!0).animate({top:0},300,(function(){$(this).removeClass("header--fixed header--fixed-show"),n.main.removeAttr("style")})))}(e,0,t,n.header.outerHeight()),t>$(this).height()?$(".js-up").addClass("js-up--is-show"):$(".js-up").removeClass("js-up--is-show")})),n.win.scroll(),$("[data-fancybox]").fancybox({lang:s,i18n:t,animationEffect:"fade"}),n.body.on("click",".js-modal-link",(function(e){e.preventDefault();var t=$(this);$.fancybox.open({src:t.attr("href"),opts:{buttons:!1,smallBtn:!1,touch:!1,animationEffect:"fade",beforeShow:function(e,s){if("#modal-certificate"===s.src){var a=t.attr("data-selectable"),n=$(s.src).find("select.js-select-certificate")[0].sumo;$(s.src).find(".js-select-certificate").next(".optWrapper").find(".opt").removeClass("selected"),void 0!==a?n.selectItem(""+a):n.selectItem(0)}},afterClose:function(){$('.modal input:not([type="submit"]),.modal textarea').removeClass("err"),$(".form-message").remove()}}})})),n.body.on("click",".js-ajax-modal-lnk",(function(e){e.preventDefault();var t=$(this);$.fancybox.open({src:t.attr("href"),type:"ajax",opts:{buttons:!1,smallBtn:!1,touch:!1,animationEffect:"fade",afterShow:function(e,s){t.attr("data-before-after")&&$(".js-before-after").twentytwenty({before_label:"До",after_label:"После"})}}})})),$(".js-phone-mask").mask("+375 (99) 999-99-99"),n.body.on("change, keyup",'input:not([type="file"],input:not([type="submit"],[type="hidden"]),textarea',(function(){var e=$(this);e.hasClass("err")&&e.val()&&e.removeClass("err")})),n.body.on("submit","form",(function(e){if(void 0===$(this).attr("data-ajax"))return r(this);e.preventDefault()})),n.body.on("click","[type = submit]",(function(){return r($(this).closest("form"),$(this))})),window.vaObj=n}));